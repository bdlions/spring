...
<div class="row form-group">
    <div class="col-md-6">
        <ul class="contact-details">
            <span class="glyphicon glyphicon-map-marker"></span> <label>Adderss:</label>
            ...
            <li><span class="glyphicon glyphicon-phone-alt"></span> <label> Telephone:</label> <?php echo $address_info['telephone'] ?></li>
            <?php if (!empty($address_info['fax'])) { ?>
                <li><span class="glyphicon glyphicon-print"></span> <label> Fax:</label> <?php echo $address_info['fax'] ?></li>
            <?php } ?>
            <li><span class="glyphicon glyphicon-envelope"></span> <label> E-mail:</label> <?php echo $address_info['email'] ?></li>
        </ul>
    </div>
    <div class="col-md-6">
...
<!--                    <div class="row  form-group">
                    ...
                    <div class="row  form-group">
                        <div class="col-md-offset-9 col-md-3">
                            <?php echo form_submit($submit_create_feedback + array('class' => 'form-control button custom-button')); ?>
                        </div>
                    </div>
                    <?php echo form_close(); ?>
                </div>
