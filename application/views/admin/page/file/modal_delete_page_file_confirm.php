<script type="text/javascript">
    $(function() {
        $("#button_delete_page").on("click", function() {
            $.ajax({
                dataType: 'json',
                type: "POST",
                url: '<?php echo base_url(); ?>' + "admin/page/delete_page_file",
                data: {
                    id: $("#input_page_id").val()
                },
                success: function(data) {
                    $("#modal_page_file_delete_confirm").modal('hide');
    ...
    function open_modal_delete_page_confirm(id) {
        ...
        $("#modal_page_file_delete_confirm").modal('show');        
    }
</script>
<div class="modal fade" id="modal_page_file_delete_confirm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="row form-group">
                        ...
                        <label class="col-sm-10 control-label">Are you sure to delete this page file?</label>
