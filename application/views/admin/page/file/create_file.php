...
$(function () {
    $("#btnSubmit").on("click", function(){
        ...
        $.ajax({
            dataType: 'json',
            type: "POST",
            url: '<?php echo base_url();?>admin/page/create_page_file',
            data: $("#form_create_page").serializeArray(),
            success: function(data) {
                alert(data.message);
                window.location = '<?php echo base_url();?>admin/page/files';
            }
        });
    });
    
    // Change this to the location of your server-side upload handler:
    var url = "<?php echo base_url();?>admin/page/create_page_file",
    ...
    $('#fileupload').fileupload({
        url: url,
        dataType: 'json',
        formData: $("form_create_page_file").serializeArray(),
        autoUpload: false,
        acceptFileTypes: /(\.|\/)(pdf|txt|gif|jpe?g|png)$/i,
        ...
        <div class="form-background top-bottom-padding">
            <div class="row">
                <div class ="col-md-8 margin-top-bottom">
                    <?php echo form_open("admin/page/create_page_file", array('id' => 'form_create_page_file', 'class' => 'form-horizontal', 'onsubmit' => 'return false;')); ?>
                    <div class ="row">
