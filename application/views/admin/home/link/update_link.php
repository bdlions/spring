        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row form-horizontal form-background top-bottom-padding">  
                    <?php echo form_open("admin/home/update_link/".$link_info['id'], array('id' => 'form_update_link', 'class' => 'form-horizontal', 'onsubmit' => 'return false;')) ?>
                    <div class="row">
                        <div class ="col-md-10 margin-top-bottom">                            
                            ...
                            <div class="form-group">
                                ...
                                <div class ="col-md-6">
                                    <?php echo form_dropdown('submenu_list', $submenu_list, $link_info['link'], 'class=form-control id=submenu_list'); ?>
                                </div> 
                            </div>
                            <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="profile-picture-box" >
                                            <div id="files" class="files">
                                                <?php if(!empty($link_info['img'])): ?>
                                                    <img style="width: 120px; height: 120px;" src="<?php echo base_url() . IMAGE_UPLOAD_PATH . $link_info['img']; ?>" class="img-responsive"/>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    $(function() {
        $("#button_create_link").on("click", function(){
        $.ajax({
            dataType: 'json',
            type: "POST",
            url: '<?php echo base_url().'admin/home/update_link/'.$link_info['id'];?>',
            data: $("#form_update_link").serializeArray(),
        ...
        var url = "<?php echo base_url().'admin/home/update_link/'.$link_info['id']; ?>",
        ...
        $('#fileupload').fileupload({
            url: url,
            dataType: 'json',
            formData: $("#form_update_link").serializeArray(),
            autoUpload: false,
            ...
            data.formData = $('#form_update_link').serializeArray();
